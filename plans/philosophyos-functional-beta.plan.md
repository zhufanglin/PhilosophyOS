...
- **开发服务后台托管：** 单入口固定使用 API 8001 与 Web 5174，`.runtime` 保存 PID 和日志；重复启动复用健康服务，端口冲突直接失败，API Key 不阻塞服务启动。
...
3. **思想档案与西方哲学家图鉴** - 用户能查找、整理、导出自己的思想，并通过西方哲学家图鉴探索思想传统。
...
| 西方哲学家图鉴 | 跨时代与传统的人物检索、筛选、思想关系和档案入口 |
...
### 3.3 [x] 建立可扩充的西方哲学家图鉴 *(completed 2026-07-31)*
...
- **What:** 首批收录不少于 60 位有广泛影响力的西方哲学家，覆盖古希腊与古罗马、中世纪基督教与伊斯兰哲学、近代、德国古典、现象学、存在主义、分析哲学、政治哲学和科学哲学等主要传统；提供姓名检索、时代/地区/流派筛选、核心思想、代表著作、人物关系和可靠来源字段。图鉴人物可进入相关每日命题与思想档案，数据与肖像资源采用可持续扩充的独立结构。
...
### 4.1 [x] 统一启动、端口和健康恢复 *(completed 2026-07-31)*
...
### 4.2 [x] 建立核心闭环端到端测试 *(completed 2026-07-31)*
